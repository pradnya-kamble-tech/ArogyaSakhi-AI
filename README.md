...
# Synthetic Demo Data
> **NOTE:** All seeded demo data generated by `app.seed` (patients, hospitals, visits, etc.) is purely synthetic and generated using [Faker](https://faker.readthedocs.io/). No real world healthcare data is present.