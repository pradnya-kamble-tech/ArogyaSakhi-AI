...
export { evaluateBaseRisk, analyzeVitals, checkDrugInteractions, matchCondition, getDifferentialDiagnosis, calculateWeightedRiskScore, CONDITIONS_DB, VITAL_RANGES, DRUG_INTERACTIONS };
